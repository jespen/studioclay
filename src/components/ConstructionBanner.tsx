      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <p className={styles.message}>
            <strong>⚠️ Under uppbyggnad:</strong> Denna webbplats är under uppbyggnad. Det mesta skall fungera men skulle du hitta något som inte fungerar - kontakta <a href="mailto:eva@studioclay.se">eva@studioclay.se</a>.
          </p>
        </div>
        <button
