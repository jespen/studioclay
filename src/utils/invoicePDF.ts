...
export async function generateInvoicePDF(
  ...
  console.log('📄 Starting invoice PDF generation', {
    ...
    customerName: `${invoiceData.customerInfo.firstName} ${invoiceData.customerInfo.lastName}`,
    productTitle: invoiceData.courseDetails.title,
    hasInvoiceDetails: !!invoiceData.invoiceDetails
  });

  try {
    // Dynamically import jsPDF (to avoid SSR issues)
    console.log('📄 Dynamically importing jsPDF...');
    const jsPDFModule = await import('jspdf');
    const jsPDF = jsPDFModule.default;
    
    if (!jsPDF) {
      console.error('📄 ERROR: jsPDF module imported but jsPDF is undefined');
      throw new Error('PDF generation module import failed');
    }
    ...
    console.log('📄 Setting up PDF content (company logo)');
    // Add company logo
    ...
    console.log('📄 Adding invoice title and details');
    ...
    console.log('📄 Adding course/product details');
    ...
    console.log('📄 Calculating VAT and totals');
    ...
    console.log('📄 Skipping QR code generation on server');
    // QR code is not generated on server to avoid complications
    ...
    console.log('📄 Generating PDF output as blob');
